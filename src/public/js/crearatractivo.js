...
//     if (nombre.value === "Vaca" || nombre.value === "Novilla") {
...
//         na1.required = false;
//     }
//     if(nombre.value === "Toro"||nombre.value === "Vaca"){
...
// let principal = document.querySelectorAll(".img_p")[0];
 let agregar = document.querySelectorAll(".agregar")[0];
